...
public class MantenimientoCargos extends javax.swing.JFrame {
    ...
    private void botoneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botoneliminarActionPerformed
        if(ValidacionEspacioEliminar()){
            ...
            dbc.EliminarRegistros(Integer.parseInt(txtidcargo.getText()));
            DeshabilitarCampos();
            botonconsultar.setEnabled(true);
            Limpiar();
        }
    ...
    private void botonguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonguardarActionPerformed
        if(ValidacionEspacioGuardar()){
            ...
            Cargo cargo = new Cargo(txtnombrecargo.getText());
            dbc.IngresoRegistros(cargo);
            DeshabilitarCampos();
            botonnuevo.setEnabled(true);
            botonconsultar.setEnabled(true);
            Limpiar();
    ...
    private void botonmodificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonmodificarActionPerformed
        if(ValidacionEspacioModificar()){
            ...
            Cargo cargo = new Cargo(Integer.parseInt(txtidcargo.getText()),txtnombrecargo.getText());
            dbc.ModificarRegistros(cargo);
            DeshabilitarCampos();
            botonconsultar.setEnabled(true);
            Limpiar();
        }
    ...
    public void Consultar(){
        Cargo cargo = dbc.ConsultarRegistros(txtnombrecargo.getText());
        if(cargo != null){
            txtidcargo.setText(Integer.toString(cargo.getId_cargos()));
            txtnombrecargo.setText(cargo.getNombre_cargos());  
        }
    }
    ...
    public boolean ValidacionEspacioModificar(){
        ...
        if(txtidcargo.getText().replaceAll("\\s+","").equals("")){
            espacio = true;
        }
        return espacio;
    }
