...
public class MantenimientoPromociones extends javax.swing.JFrame {
    ...
    private void botoneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botoneliminarActionPerformed
        if(ValidacionEspaciosEliminar()){
            ...
            dbp.EliminarRegistros(Integer.parseInt(txtidpromocion.getText()));
            DeshabilitarCampos();
            Limpiar();
    ...
    private void botonguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonguardarActionPerformed
        if(ValidacionEspaciosGuardar()){
            ...
            Promocion promocion = new Promocion(txtcodigo.getText(),txtnombre.getText(),txtadescripcion.getText(),
                    cbtipo.getSelectedItem().toString());
            dbp.IngresarRegistros(promocion);
            DeshabilitarCampos();
            Limpiar();
            botonnuevo.setEnabled(true);
            botonconsultar.setEnabled(true);
    ...
    private void botonmodificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonmodificarActionPerformed
        if(ValidacionEspaciosModificar()){
            ...
            Promocion promocion = new Promocion(Integer.parseInt(txtidpromocion.getText()),txtcodigo.getText(),txtnombre.getText(),
                    txtadescripcion.getText(),cbtipo.getSelectedItem().toString());
            dbp.ModificarRegistros(promocion);
            DeshabilitarCampos();
            Limpiar();
            botonnuevo.setEnabled(true);
            botonconsultar.setEnabled(true);
    ...
    public void Consultar(){
        Promocion promocion = dbp.ConsultarRegistros(txtcodigo.getText());
        if(promocion != null){
            txtcodigo.setText(promocion.getCodigo_promocion());
            txtnombre.setText(promocion.getNombre_promocion());
            txtadescripcion.setText(promocion.getDescripcion());
            cbtipo.setSelectedItem(promocion.getTipo());
            txtidpromocion.setText(Integer.toString(promocion.getId_promociones()));
        }
    }
    ...
    public boolean ValidacionEspaciosModificar(){
        ...
        if(txtidpromocion.getText().replaceAll("\\s", "").equals("")){
            espacio = true;
        }
        return espacio;       
    }
